"""
Django settings for bids_tryworks project.
...
class ServerConfigError(Exception):
    ...
    def __str__(self):
        message = """
        Check server config yaml file in bidsgu2/bids_tryworks folder.
...
DJANGO_SETTINGS_MODULE = os.path.join(BASE_DIR, 'bids_tryworks/settings.py')
...
# folder of where bids_tryworks lives.
...
ROOT_URLCONF = 'bids_tryworks.urls'
...
WSGI_APPLICATION = 'bids_tryworks.wsgi.application'
