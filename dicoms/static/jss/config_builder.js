...
$(document).on( "change", "input", function () {
    let reuse_conversion_form = $('#select_conversion_file_checkbox').is(':checked')
    if (reuse_conversion_form) {
        // hide field for new conversion form file name
        $(".config_name").hide()
        // hide text box and upload json buttons above
        $(".upload-conversion-json").hide()
        // hide check box and label for create custom config
        $(".make_new_checkbox").hide()
    } else {
        // show make_new_check box
        $(".make_new_checkbox").show()
    }
...
$(document).on("change", "input", function f() {
    ...
    let create_new = $('#upload_new_checkbox').is(':checked');
    if (create_new) {
        // show conversion builder
        // hide load previous config file
        $("#build_conversion_file").show();
