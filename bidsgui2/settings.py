"""
Django settings for bids-tryworks project.
...
class ServerConfigError(Exception):
    ...
    def __str__(self):
        message = """
        Check server config yaml file in bidsgu2/bids-tryworks folder.
...
DJANGO_SETTINGS_MODULE = os.path.join(BASE_DIR, 'bids-tryworks/settings.py')
...
# folder of where bids-tryworks lives.
...
ROOT_URLCONF = 'bids-tryworks.urls'
...
WSGI_APPLICATION = 'bids-tryworks.wsgi.application'
